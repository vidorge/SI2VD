...
(function($){	
	...
	_lang = {
			ans:{	// _lang.ans are shown during the display of .q-result, the answer result.
				corrAns: "Tačan odgovor je:",
				praise: 'Tačan odgovor, čestitamo!',
			...
			btn:{	// [ "text", "title" ]
				begin: [ "Begin Quiz" ],
				check: [ "Proveri", "Check your answer" ],
				del: [ "Delete", "Delete quiz" ],
				help: [ "Help", 'Click for help'],
				next: [ "Dalje", "Next question" ],
				restart: [ "Pokušajte ponovo", "Restart the quit over" ],
			...
			stats:{
				right: "Tačnih odgovora",
				rate: "Netačnih odgovora",
				score: "Odgovorenih pitanja",
				wrong: "Netačnih odgovora",
				total: "Ukupno",
				tried: "Tried"
			},
			quiz:{
